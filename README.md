...
2) docker run -p 9200:9200 -d --name elasticsearch \
...
4) Access the URL http://localhost:9200 to check the details about the Elastic Search container.
5) Access the URL http://localhost:9200/indexName (this can be any name given to your index in the entity class in your Spring Boot project).
